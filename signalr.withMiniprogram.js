        ...
        if (transport === null || transport === undefined) {
            ...
            if (transportMatches(requestedTransport, transport)) {
                if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
                    if ((transport === _ITransport__WEBPACK_IMPORTED_MODULE_2__["HttpTransportType"].WebSockets && typeof WebSocket === "undefined" && typeof wx.connectSocket === "undefined") ||
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _Utils__WEBPACK_IMPORTED_MODULE_2__["Arg"].isIn(transferFormat, _ITransport__WEBPACK_IMPORTED_MODULE_1__["TransferFormat"], "transferFormat");
                        // 判断是否微信小程序
                        if (typeof (WebSocket) === "undefined" && typeof (wx.connectSocket) === "undefined") {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                ...
                                if (WebSocket ) {
                                  ...
                                  webSocket.onError(function (errMsg) {
                                      reject(errMsg);
                                  });
                                  webSocket.onMessage(function (message) {
                                      _this.logger.log(_ILogger__WEBPACK_IMPORTED_MODULE_0__["LogLevel"].Trace, "(WebSockets transport) data received. " + Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["getDataDetail"])(message.data, _this.logMessageContent) + ".");
